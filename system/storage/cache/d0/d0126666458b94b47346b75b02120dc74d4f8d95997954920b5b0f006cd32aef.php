...
class __TwigTemplate_c8268abcff0dd381e77ea88463e422cba8f17e2b40a43ce9226f23011b82ee99 extends Twig_Template
{
      ...
      <ul class=\"dropdown-menu\" aria-labelledby=\"dropdown-language\">
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                // line 15
                echo "        <li>
          <a class=\"language-select btn btn-sm btn-link btn-block\" name=\"";
                // line 16
                echo $this->getAttribute($context["language"], "code", array());
                echo "\"><img src=\"catalog/language/";
                echo $this->getAttribute($context["language"], "code", array());
...
/*         {% for language in languages %}*/
/*         <li>*/
/*           <a class="language-select btn btn-sm btn-link btn-block" name="{{ language.code }}"><img src="catalog/language/{{ language.code }}/{{ language.code }}.png" alt="{{ language.name }}" title="{{ language.name }}" /> {{ language.name }}</a>*/
/*         </li>*/
/*         {% endfor %}*/
/*       </ul>*/
/*     </div>*/
