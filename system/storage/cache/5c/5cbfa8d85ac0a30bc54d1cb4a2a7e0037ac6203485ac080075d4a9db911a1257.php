...
/* design/theme.twig */
class __TwigTemplate_925949d0ac13a08e2508cff043e8a158c9c0fe6ac82ad9be5d94773106a2aa0c extends Twig_Template
{
...
\t\t\t\t\thtml += '<a href=\"' + json['directory'][i]['path'] + '\" class=\"list-group-item directory\">' + json['directory'][i]['name'] + ' <i class=\"fas fa-arrow-right fa-fw float-right\"></i></a>';
\t\t\t\t}
\t\t\t}

\t\t\tif (json['file']) {
\t\t\t\tfor (i = 0; i < json['file'].length; i++) {
\t\t\t\t\thtml += '<a href=\"' + json['file'][i]['path'] + '\" class=\"list-group-item file\">' + json['file'][i]['name'] + ' <i class=\"fas fa-arrow-right fa-fw float-right\"></i></a>';
\t\t\t\t}
\t\t\t}
...
\t\t\tif (json['back']) {
\t\t\t\thtml += '<a href=\"' + json['back']['path'] + '\" class=\"list-group-item directory\">' + json['back']['name'] + ' <i class=\"fas fa-arrow-left fa-fw float-right\"></i></a>';
\t\t\t}
...
/* 					html += '  <br />';*/
/* 					html += '  <div class="float-right">';*/
/* 					html += '    <button type="button" data-loading-text="{{ text_loading }}" class="btn btn-primary"><i class="fas fa-save"></i> {{ button_save }}</button>';*/
/* 					html += '    <button data-loading-text="{{ text_loading }}" class="btn btn-danger"><i class="fas fa-recycle"></i> {{ button_reset }}</button>';*/
/* 					html += '  </div>';*/
/* 					html += '</div>';*/
/* */
/* 					$('.tab-content').append(html);*/
