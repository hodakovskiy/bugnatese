...
/* tool/upload.twig */
class __TwigTemplate_38565e5844ee95faffb5911b821eb805081965477a28314e9e0274c83de9b147 extends Twig_Template
{
...
<div id=\"content\">
  ...
  <div class=\"container-fluid\">";
    ...
    ";
        ...
        // line 29
        echo "    <div class=\"row\">
      <div id=\"filter-upload\" class=\"col-md-3 col-sm-12 order-md-9 d-none d-md-block\">
        <div class=\"card\">
...
";
    ...
    {
        return array (  327 => 130,  298 => 104,  285 => 94,  281 => 93,  274 => 88,  268 => 85,  265 => 84,  262 => 83,  251 => 80,  247 => 79,  243 => 78,  239 => 77,  236 => 76,  230 => 75,  224 => 73,  222 => 72,  219 => 71,  214 => 70,  212 => 69,  205 => 65,  187 => 64,  169 => 63,  151 => 62,  142 => 56,  137 => 54,  127 => 47,  113 => 40,  108 => 38,  98 => 35,  92 => 32,  87 => 29,  79 => 25,  76 => 24,  68 => 20,  66 => 19,  60 => 15,  49 => 13,  45 => 12,  39 => 9,  32 => 7,  28 => 6,  19 => 1,);
    }
}
/* {{ header }}{{ column_left }}*/
/* <div id="content">*/
...
/*     <div class="container-fluid">*/
/*       <div class="float-right">*/
/*         <button type="button" data-toggle="tooltip" title="{{ button_filter }}" onclick="$('#filter-upload').toggleClass('d-none');" class="btn btn-light d-md-none"><i class="fas fa-filter"></i></button>*/
/*         <button type="button" data-toggle="tooltip" title="{{ button_delete }}" class="btn btn-danger" onclick="confirm('{{ text_confirm }}') ? $('#form-upload').submit() : false;"><i class="fas fa-trash-alt"></i></button>*/
/*       </div>*/
/*       <h1>{{ heading_title }}</h1>*/
/*       <nav aria-label="breadcrumb">*/
/*         <ol class="breadcrumb">*/
...
/*                           <td class="text-right"><a href="{{ upload.download }}" data-toggle="tooltip" title="{{ button_download }}" class="btn btn-info"><i class="fas fa-download"></i></a></td>*/
/*                         </tr>*/
/*                       {% endfor %}*/
/*                     {% else %}*/
/*                       <tr>*/
