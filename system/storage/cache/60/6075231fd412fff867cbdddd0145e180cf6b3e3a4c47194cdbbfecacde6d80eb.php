...
class __TwigTemplate_875baa74d53a0b9fa2cd5acc50b8825398773965320d403d7d45871ab904aab7 extends Twig_Template
{
...
/*       <td class="text-right"><button type="button" value="{{ history.extension_install_id }}" data-loading="{{ text_loading }}" data-toggle="tooltip" title="{{ button_uninstall }}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button></td>*/
/*     </tr>*/
/*     {% endfor %}*/
/*     {% else %}*/
/*     <tr>*/
